...
## 结课报告
通过本次实践课，我们小组学习了如何通过js来实现区块链技术。在老师逐步深入的教导下，我们小组最终完成了该实践课的学习与理解。
在过程中，我们遇到了很多困难，例如不熟悉js语言、无法对代码进行debug等技术性问题。但是，在小组成员的不懈努力以及同学的耐心教导下，
我们几经波折，最终还是完成了该项目。 这次实践课让我们深刻地认识到自身还有诸多不足。我们小组一致希望，在后续的学习生涯中能够继续合作，
完成更复杂的项目。我们也希望能够不断提高自己的技能，为未来的项目做好充分准备。 总之，这次实践课对我们来说是一次宝贵的学习经历。
它不仅让我们掌握了如何通过js来实现区块链技术，还锻炼了我们解决问题和团队合作的能力。我们将珍惜这次经历，并在未来继续努力。
